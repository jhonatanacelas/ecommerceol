    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, max_length=128, null=True, verbose_name='dirección')),
                ('document_type', models.CharField(blank=True, max_length=2, null=True)),
                ('document_number', models.CharField(blank=True, max_length=11, null=True, validators=[django.core.validators.RegexValidator(message='Debe ser solo números', regex='^(\\d)*$')])),
